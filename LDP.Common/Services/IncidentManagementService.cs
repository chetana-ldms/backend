...
namespace LDP_APIs.Services
{
    public class IncidentManagementService : IIncidentManagementService
    {
        ...
        public async Task<CreateIncidentInternalResponse> CreateIncident(CreateIncidentDTO dto)
        {
            ...
            CreateIncidentInternalResponse reRresponse = new CreateIncidentInternalResponse();
        ...
        public async Task<GetIncidentsResponse> GetIncidents()
        {
           ...
           // string apiPath = "/api/v2/tickets/1"; // API path
            ...
            try
            {
               ...
               // returnresponse.IncidentList = incidentDtlsList;
            }
        ...
        public Task<GetIncidentsResponse> GetIncidents(GetIncidentsRequest request, OrganizationToolModel connectiondtl)

        {
            throw new NotImplementedException();
        }

        public Task<GetIncidentsResponse> GetIncidentsByClientToolPKIds(List<string> ClientToolPKIds, OrganizationToolModel connectiondtl)
        {
            throw new NotImplementedException();
        }
    }
