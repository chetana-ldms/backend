...
namespace LDP_APIs.Services
{
    public class FreshDesk_IncidentManagementService : IIncidentManagementService
    {
        ...
        //public FreshDesk_IncidentManagementService(IHttpClientFactory? httpClientFactory)
        //{
        //   // _httpClientFactory = httpClientFactory;
        //}

        public FreshDesk_IncidentManagementService()
        {
        }
        ...
        public async Task<GetIncidentsResponse> GetIncidents1()
        {
